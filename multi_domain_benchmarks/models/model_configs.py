            ...
            return {
                    'model_conf':{
                        'env_args': EnvArgs(in_dim=params['in_dim'], hid_dim=params['hid_dim'], out_dim=params['out_dim'], #edge_dim=params['edge_dim'],
                                            ...
                                            conv_dropout=params['conv_dropout'],  act_type=params['act_type'], pos_enc=params['pos_enc'],  
                                            ...
                                            conv_residual=params['conv_residual'],
                                            mlp_residual=params['mlp_residual'],
                                            post_dropout=params['post_dropout'],
    ...
    def get_conf(self, dataset_type, dataset, pos_enc):
        ...
        if dataset_type.get_family() is DataSetFamily.gpp:
            ...
            shared_hyperparams = {
                ...
                'conv_dropout': [0.0, 0.2],
                'post_dropout': [0.0, 0.2],
                'conv_residual': [True, False],
                'mlp_residual': [True, False],
                'num_iters': [8,12,16],
                'num_layers': [3,4],
